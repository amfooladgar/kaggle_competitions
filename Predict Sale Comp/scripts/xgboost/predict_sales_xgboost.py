#Kaggle Predict Future Sales by Denis Larionov: Feature engineering, xgboost:   https://www.kaggle.com/dlarionov/feature-engineering-xgboost
import numpy as np
import pandas as pd
...
#Outliers
#There are items with strange prices and sales. After detailed exploration I decided to remove items with price > 100000 
# and sales > 1001 (1000 is ok).
...
# Якутск ТЦ "Центральный"    Yakutsk shopping center "Central"
...
I use floats instead of ints for item_cnt_month to avoid downcasting it after concatination with the test set later. 
...
matrix.to_pickle('../../data/processed/data.pkl')
del matrix
del cache
del group
del items
