...
##            Complete_train_set=Complete_train_set.append(df1,ignore_index = True)
#
#Complete_train_set.to_csv(r'../../data/processed/complete_train_set.csv')
...
To_submit_results.to_csv(r'../../submissions/lstm_monthly/submission_monthly_window3_shop_features.csv',index=False)


# ----------------------to save and load the trained model
import pickle
# to export the trained model
with open('../../models/lstm_monthly/model_lstm_trained_monthly_window2_featuresShpIdBlkId_1Epoch', 'wb') as model_lstm_trained_monthly_window2_featuresShpIdBlkId_1Epoch:
    pickle.dump(model_lstm, model_lstm_trained_monthly_window2_featuresShpIdBlkId_1Epoch)
    
#to Import the trained model
with open('../../models/lstm_monthly/model_lstm_trained_monthly_window2_featuresShpIdBlkId_1Epoch', 'rb') as model_lstm_trained_monthly_window2_featuresShpIdBlkId_1Epoch:
